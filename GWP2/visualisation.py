...
COLORS = [
    ...
    "#A3BE8C",  # Meadow (Green)
    "#BF616A",  # Aurora (Red)
    "#B48EAD",  # Lavender (Purple)
    "#4C566A",  # Polar Night (Dark Gray)
    "#EBCB8B",  # Ray (Yellow)
    "#C72C41",  # Reddish (Red)
    "#D08770",  # Horizon (Orange)
    "#81A1C1",  # Dusk (Blue)
    "#ECEFF4",  # Frost (Light Blue)
    "#D8DEE9",  # Polar Night (Gray)
    "#88C0D0",  # Glacier (Light Blue)
    "#E3E3E3",  # Snowstorm (White)
    "#EE4540",  # Cherry (Red)
    "#8FBCBB",  # Frost (Blue) (Repeating for emphasis)
    "#D8DEE9",  # Polar Night (Gray) (Repeating for emphasis)
    "#2E3440",  # Polar Night (Dark Gray) (Repeating for emphasis)
    "#434C5E",  # Polar Night (Dark Gray) (Repeating for emphasis)
    "#EBCB8B",  # Ray (Yellow) (Repeating for emphasis)
    "#E5E9F0"   # Frost (Light Blue) (Repeating for emphasis)
]
